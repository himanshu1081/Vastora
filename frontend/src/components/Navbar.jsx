...
const Navbar = () => {
    ...
    const Settings = () => {
        return (
            <>
                ...
                <div
                    className={`transition-all duration-300 ease-in-out absolute top-5 md:top-10 right-2 z-25 h-fit 
                    ...
                    <div className="flex justify-start items-center gap-2 p-2 md:py-3 w-full hover:bg-[#1b1f22] hover:cursor-pointer">
...

                    {
                        ...
                        <>
                            ...
                            <NavLink
                                to='/'
                                onClick={() => { handleLogout(); setDropdown(null) }}
    ...
    return (
        <>
            ...
            ${sidebar ? "z-25" : "z-50"}
             bg-black text-white flex items-center justify-around sm:justify-between w-full h-10 sm:h-20 font-figtree md:px-12 `}
            >
                ...
                <div
                    ...
                    bg-[#3f464d] h-6 w-50 sm:w-70 sm:h-10 md:w-100 rounded-4xl p-1 sm:p-2 md:p-4 border
                  border-gray-400 hover:bg-[#1c1e1e]">
                    <input type="text"
                    ...
                    <IoIosSearch
                        color="white"
                        className="transition all 100ms hover:bg-zinc-800 rounded-full size-6 sm:size-9 p-1 cursor-pointer" />
                </div>
                <div
                    ...
                    {isLoggedIn ?
                        ...
                        (<div className="flex gap-1 md:gap-4 items-center justify-center md:justify-between pr-3 ">
                            ...
                            <NavLink to='/login'
                                ...
                                h-5 sm:h-10 w-10 sm:w-20 text-xs sm:text-base md:text-xl p-2 rounded-4xl font-extrabold hover:bg-[#3f464d]"
                            >Login
                            </NavLink>
                        </div>)
                    }

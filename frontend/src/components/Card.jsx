...
const Card = ({ username, channelName, avatar, title, viewCount, thumbnail, date, onClick }) => {
    ...
    return (
        <>
            <div onClick={onClick}
                className="transition-all duration-50 md:h-4/4 w-10/12 sm:w-full md:w-full border-2 border-white/20 backdrop-blur-2xl bg-[#0b0b0b] text-white rounded-2xl p-2 scale-100 hover:scale-101 hover:bg-[#8200db]/10 cursor-pointer">
